...
public class Test0301_0 {
    ...
    /**  This, in 《1.brief》 ,is what the Futurist says: for a century, past 《2.conditions》 of life have been conditionally speeding up,
     ...
     已经《经历;经历体验》《5.相应的》改变。这种生活加速,未来主义者说，需要一风格新的《6.表达方式》。
     《7.无妨碍》的停止，形容词,动词。我们创造词汇模仿他们而不是声音，
     ...
     **/
     ...
     /**
      ...
      no thinking man can refuse to accept their first 《proposition》: that a great change in our emotional life calls for a change of expression.
      The whole question is really this: have we essentially changed?
      通过符合和未来主义诗歌的需求,归入文学是困难的，尽管如此
       没有一个有思考的人能拒绝接受他们第一个《观点》：表达改变在我们情绪化生活中是一个不错的改变。
     **/


    /**
     19.This passage is mainly	.
     [A]a survey《纵览》 of new approaches《方法》 to art
     [B]a review of Futurist poetry
     [C]about merits《优劣》 of the Futurist movement
     [D]about laws and requirements of literature

     20.When a novel《新奇的,小说》 literary idea appears, people should try to	.
     [A] determine its purposes《确定他的目标》
     [B] ignore its flaws
     [C] follow the new fashions
     [D] accept the principles《原则》

     21.Futurists claim that we must_.
     [A]increase the production of literature
     [B]use poetry to relieve《减缓》 modem stress(pressure)《压力》
     [C]develop new modes of expression
     [D]avoid using adjectives and verbs

     22.The author believes that Futurist poetry is	.
     [A]based on reasonable principles《根据合理的原则》
     [B]new and acceptable to ordinary《普通》 people
     [C]indicative《参与》 of basic change in human nature《人性》
     [D]more of a transient(moment)《短暂》 phenomenon《现象》 than literature
